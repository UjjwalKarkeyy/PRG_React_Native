# Generated by Django 5.2.4 on 2025-08-13 13:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='media_content', to='healthContent.healthcategory')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='views', to='healthContent.mediacontent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('content', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ratings', to='healthContent.mediacontent')),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['category', 'is_active'], name='healthConte_categor_0b31da_idx'),
        ),
        migrations.AddIndex(
            model_name='mediacontent',
            index=models.Index(fields=['content_type', 'is_active'], name='healthConte_content_6a87b4_idx'),
        ),
        migrations.AddIndex(
            model_name='mediacontent',
            index=models.Index(fields=['is_featured', 'is_active'], name='healthConte_is_feat_c79473_idx'),
        ),
        migrations.AddIndex(
            model_name='contentview',
            index=models.Index(fields=['content', 'viewed_at'], name='healthConte_content_ce66fd_idx'),
        ),
